...
class PacketMotionData(ctypes.LittleEndianStructure): # id 0
    """
...
class PacketSessionData(ctypes.LittleEndianStructure):  # id 1
    """
...
class PacketLapData(ctypes.LittleEndianStructure):  # id 2
    """
...
class PacketEventData(ctypes.LittleEndianStructure):  # id 3
    """
...
class PacketParticipantsData(ctypes.LittleEndianStructure):  # id 4
    """
...
class PacketCarSetupData(ctypes.LittleEndianStructure):  # id 5
    """
...
class PacketCarTelemetryData(ctypes.LittleEndianStructure):  # id 6
    """
...
class PacketCarStatusData(ctypes.LittleEndianStructure):  # id 7
    """
